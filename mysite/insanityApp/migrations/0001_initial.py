# Generated by Django 2.1.4 on 2019-01-08 14:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_type', models.CharField(choices=[('Man', 'man'), ('Woman', 'woman'), ('Accessoriese', 'accessoriese'), ('Bracialet', 'bracialet')], default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='', max_length=10)),
                ('size', models.CharField(choices=[('XS', 'XS'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL')], default='', max_length=20)),
